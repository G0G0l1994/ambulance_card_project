...
class CardForm(FlaskForm):
  ...
  characteristic_pulse = SelectMultipleField("Пульс", choices=[("Нормальный", "Нормальный"),("Слабого наполнения", "Слабого наполнения"), ("Напряжённый", "Напряжённый"), ("Нитевидный", "Нитевидный"), ("Отсутствует", "Отсутствует")], default="Нормальный")
  ...
  anisocoria = BooleanField("Анизокория:", default=True)
  nystagmus = BooleanField("Нистагм:", default=True)
