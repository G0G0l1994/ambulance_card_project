...
class CardForm(FlaskForm):
  ...
  respiratory_rate_before = IntegerField("ЧДД",default=15)
  saturation_before = IntegerField("SpO2", default=0)
  heartbite_before = IntegerField("ЧСС", default=0)
  pulse_before = IntegerField("Пульс", default=0)
